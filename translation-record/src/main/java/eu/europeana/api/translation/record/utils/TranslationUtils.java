...
public class TranslationUtils {
     ...
     * @return
     */
    public static boolean ifValuesShouldBePickedForTranslation(Map<String, List<String>> map, String sourceLang) {
    ...
    private static List<String> truncate(List<String> valuesToTranslate , Integer translationCharLimit, Integer translationCharTolerance) {
