...
public class MetadataLangDetectionService extends BaseService {
     ...
     */
    public MetadataLangDetectionService(LanguageDetectionService detectionService) {
     ...
     */
    public FullBean detectLanguageForProxy(FullBean bean) throws EuropeanaApiException, LanguageDetectionException {
