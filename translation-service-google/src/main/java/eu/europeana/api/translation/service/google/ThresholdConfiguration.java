...
public class ThresholdConfiguration {
  ...
  @JsonGetter(GLangDetectConstants.MIN_LENGTH)
  public Integer getMinLength() {
    return minLength;
  }

  @JsonSetter(GLangDetectConstants.MIN_LENGTH)
  public void setMinLength(Integer minLength) {
    this.minLength = minLength;
  }

  @JsonGetter(GLangDetectConstants.MAX_LENGTH)
  public Integer getMaxLength() {
    return maxLength;
  }

  @JsonSetter(GLangDetectConstants.MAX_LENGTH)
  public void setMaxLength(Integer maxLength) {
    this.maxLength = maxLength;
  }

  @JsonGetter(GLangDetectConstants.CONFIDENCE_THRESHOLD)
  public Double getConfidenceThreshold() {
    return confidenceThreshold;
  }

  @JsonSetter(GLangDetectConstants.CONFIDENCE_THRESHOLD)
