...
public class ExternalServiceCallException extends EuropeanaI18nApiException {
  ...
  public ExternalServiceCallException(String msg, String errorCode, String error, HttpStatus responseStatus, String i18nKey, List<String> i18nParams, Throwable th) {
