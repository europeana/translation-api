...
public interface BeanNames {
  ...
  String BEAN_APACHE_TIKA_LANG_DETECT_THRESHOLDS_SERVICE = "apacheTikaLangDetectThresholdsService";
  ...
  String BEAN_GOOGLE_LANG_DETECT_THRESHOLDS_SERVICE = "googleLangDetectThresholdsService";
