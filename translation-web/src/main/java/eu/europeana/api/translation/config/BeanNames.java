...
public interface BeanNames {
  ...
  String BEAN_APACHE_TIKA_THRESHOLDS_LANG_DETECT_SERVICE = "apacheTikaLangDetectThresholdsService";
  ...
  String BEAN_GOOGLE_LANG_THRESHOLDS_DETECT_SERVICE = "googleLangDetectThresholdsService";
