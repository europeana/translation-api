...
public abstract class IntegrationTestUtils {
  ...
  protected static final String LANG_DETECT_PANGEANIC_REQUEST = "/content/lang_detection_pangeanic_request.json";
  protected static final String LANG_DETECT_PANGEANIC_RESPONSE = "/content/lang_detection_pangeanic_response.json";
  
  protected static final String LANG_DETECT_REQUEST_2 = "/content/lang_detection_request_2.json";
  protected static final String LANG_DETECT_PANGEANIC_REQUEST_2 = "/content/lang_detection_pangeanic_request_2.json";
  protected static final String LANG_DETECT_PANGEANIC_RESPONSE_2 = "/content/lang_detection_pangeanic_response_2.json";
